...
export async function GET(req: NextRequest) {
  ...
  const params = new URLSearchParams({
    ...
    state,
    scope:        'search:docs:read drive:drive.search:readonly docs:document:export contact:user.id:readonly contact:user.base:readonly contact:user.email:readonly im:chat:read im:chat.members:write_only im:message im:resource docx:document:readonly',
  });
