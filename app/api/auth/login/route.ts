...
export async function GET(req: NextRequest) {
  ...
  const params = new URLSearchParams({
    ...
    state,
    scope:        'search:docs:read drive:drive.search:readonly contact:user.id:readonly im:chat:read im:chat.members:write_only im:message:readonly im:resource docx:document:readonly',
  });
