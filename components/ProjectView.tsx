...
export function ProjectView({ features, setFeatures, pinnedId, onClearPin }: Props) {
  ...
  const listGridCls = 'flex flex-col gap-2 sm:grid sm:grid-cols-[minmax(0,320px)_max-content_max-content_max-content_max-content_max-content_max-content_max-content] sm:gap-x-1.5 sm:gap-y-2';
